...
const Nav = forwardRef((props,ref)=> (      ///when we wrap forwardRef we can pass the ref to the component and define ref in the parent component return statement is not allowed
